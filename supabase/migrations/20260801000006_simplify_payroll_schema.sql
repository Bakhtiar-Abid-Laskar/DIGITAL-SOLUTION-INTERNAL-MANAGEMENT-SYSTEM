-- Migration: 20260801000006_simplify_payroll_schema
-- Description: Drop unused columns from staff_rates to simplify payroll configuration
...
alter table public.staff_rates
  ...
  -- Phase 5 flags/tiers that are no longer needed
