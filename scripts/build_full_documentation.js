...
console.log('Generating complete PROJECT_DOCUMENTATION.md...');

const docContent = `# PROJECT_DOCUMENTATION.md — Canonical System Architecture & Codebase Reference
...
fs.writeFileSync('PROJECT_DOCUMENTATION.md', docContent, 'utf8');
console.log('PROJECT_DOCUMENTATION.md successfully written. Total size:', docContent.length, 'bytes');
